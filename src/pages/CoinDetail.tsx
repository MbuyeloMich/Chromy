...
import { fmt, pct, compactNum, fullCurrency } from '../utils';
                  ...
                  <div class="grid lg:grid-cols-[1fr_340px] gap-6">
                    ...
                    <div class="space-y-4">
                      <Card>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                          <MiniStatCard label="Market Cap" value={fullCurrency(c().market_data.market_cap.usd)} />
                          <MiniStatCard label="Volume (24h)" value={fullCurrency(volume())} live={isLive()} />
