...
import { fullCurrency } from '../utils';
        ...
        <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
          <ErrorBoundary>
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
              <StatCard label="Market Cap" value={fullCurrency(marketStats().mcap)} live={isLive()} />
              <StatCard label="24h Volume" value={fullCurrency(marketStats().vol)} live={isLive()} />
